...
const (
	// statements
	/* [x] */ PackageStatementKind StatementKind = "statement:package"
	/* [ ] */ UseStatementKind StatementKind = "statement:use"
	/* [x] */ ReturnStatementKind StatementKind = "statement:return"
	/* [x] */ BreakStatementKind StatementKind = "statement:break"
	/* [x] */ ContinueStatementKind StatementKind = "statement:continue"
	/* [x] */ YieldStatementKind StatementKind = "statement:yield"
	/* [x] */ DeclarationStatementKind StatementKind = "statement:declaration"
	/* [x] */ AssignmentStatementKind StatementKind = "statement:assignment"
	...
	/* [x] */ UnboundFunDefinitionStatementKind StatementKind = "statement:unbound-fun-definition"
	/* [ ] */ BoundFunDefinitionStatementKind StatementKind = "statement:bound-fun-definition"
	/* [x] */ ExpressionStatementKind StatementKind = "statement:expression"
	/* [-] */ LoopStatementKind StatementKind = "statement:loop"
	/* [x] */ IfStatementKind StatementKind = "statement:if"
	/* [x] */ SingleLineCommentStatementKind StatementKind = "statement:single_line_comment"
	/* [x] */ MultiLineCommentStatementKind StatementKind = "statement:multi_line_comment"

	// expressions
	/* [x] */
	IdentifierExpressionKind ExpressionKind = "expression:identifier"
	/* [x] */ ArithmeticExpressionKind ExpressionKind = "expression:arithmetic"
	/* [x] */ BinaryExpressionKind ExpressionKind = "expression:binary"
	/* [x] */ ComparisonExpressionKind ExpressionKind = "expression:comparison"
	/* [x] */ CallExpressionKind ExpressionKind = "expression:call"
	/* [x] */ MemberExpressionKind ExpressionKind = "expression:member"
	/* [x] */ IndexExpressionKind ExpressionKind = "expression:index"
	...
	/* [x] */ MatchSelfExpressionKind ExpressionKind = "expression:match_self"
	/* [x] */ GroupExpressionKind ExpressionKind = "expression:group"
	/* [x] */ ThisExpressionKind ExpressionKind = "expression:this"
	...
	/* [x] */ NotExpressionKind ExpressionKind = "expression:not"
	/* [x] */ GiveupExpressionKind ExpressionKind = "expression:giveup"
	...
	/* [x] */ BoolLiteralExpressionKind ExpressionKind = "expression:bool-literal"
	/* [-] */ NumberLiteralExpressionKind ExpressionKind = "expression:number-literal"
	/* [x] */ ListLiteralExpressionKind ExpressionKind = "expression:list-literal"
	/* [x] */ MapLiteralExpressionKind ExpressionKind = "expression:map-literal"
